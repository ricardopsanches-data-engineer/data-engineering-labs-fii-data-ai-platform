resource "aws_iam_policy" "ecr_admin" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      {
        Sid    = "EcrPlatformRepositoryManagement"
        Effect = "Allow"
        ...
        Resource = [
          ...
          "arn:aws:ecr:sa-east-1:625685670804:repository/fii-data-ai-platform-dev-fii-master-gold"
        ]
      },
      {
        Sid    = "EcrPlatformImageManagement"
        Effect = "Allow"
