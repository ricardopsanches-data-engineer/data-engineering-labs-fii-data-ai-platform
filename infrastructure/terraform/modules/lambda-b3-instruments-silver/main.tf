...
resource "aws_iam_policy" "lambda_execution" {
  ...
  description = "Least-privilege permissions for the B3 Instruments RAW to Silver Lambda."
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "${var.data_lake_bucket_arn}/raw/b3-instruments/*"
      },
      {
        Sid    = "ReadWriteB3InstrumentsSilver"
        Effect = "Allow"
...
resource "aws_lambda_function" "b3_instruments_raw_to_silver" {
