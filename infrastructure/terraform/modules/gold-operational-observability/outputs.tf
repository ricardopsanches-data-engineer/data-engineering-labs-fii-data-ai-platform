...
output "sns_topic_name" {
  description = "Name of the SNS topic used for Gold operational alerts."
  value       = aws_sns_topic.gold_operational_alerts.name
}

output "sns_topic_arn" {
  description = "ARN of the SNS topic used for Gold operational alerts."
  value       = aws_sns_topic.gold_operational_alerts.arn
}